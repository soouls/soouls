          ...
          <section className="relative flex flex-col justify-between overflow-hidden p-10 lg:p-16">
            ...
            <div className="relative">
              ...
              <p className="mt-6 max-w-md text-lg leading-relaxed text-slate-400">
                Operating system for support, engineering, and platform administration. Access is strictly audited.
              </p>
            </div>
                ...
                <SignIn 
                  ...
                  appearance={{
                    elements: {
                      ...
                      formButtonPrimary: "bg-slate-950 hover:bg-slate-800 text-white rounded-xl py-3 transition-colors",
                      formFieldInput: "rounded-xl border-slate-200 focus:border-slate-400 focus:ring-slate-400",
