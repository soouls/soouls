      ...
      <Panel title="System Operations">
        {!filteredLogs ? (
          ...
          <EmptyState
            ...
            title="No logs found"
            description={searchTerm ? 'No logs match your search.' : 'The audit trail is currently empty.'}
          />
        ) : (
                  ...
                  >
                    ...
                    <td className="py-3 pl-4 align-top">
                      <div className="text-slate-300">
                        {log.targetType} <span className="text-slate-500">#{log.targetId?.slice(0, 8) ?? 'global'}</span>
                      </div>
