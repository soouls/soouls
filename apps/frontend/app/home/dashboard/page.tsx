          ...
          >
            <div className="flex-1 p-8 md:p-10 space-y-10 overflow-y-auto custom-scrollbar">
              ...
              <div className="space-y-6">
                <h2 className="text-[20px] font-medium text-white/90 px-2">
              ...
              >
                ...
                <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <motion.div
                    ...
                    className="bg-[#111111] border border-white/[0.05] rounded-[24px] p-8 flex flex-col gap-6"
                  >
                    ...
                    <div className="flex-1 rounded-[20px] bg-[#0A0A0A] border border-white/[0.03] relative p-6 overflow-hidden min-h-[350px]">
                      ...
                      {!clusterEntries.length && (
                        <div className="absolute inset-0 flex items-center justify-center text-white/30 text-[14px] font-light italic text-center px-6">
                          Your cluster map will appear as you write more. Start a new entry to
                          begin.
                        </div>
                      )}
                  ...
                  <motion.div
                    ...
                    className="bg-[#111111] border border-white/[0.05] rounded-[24px] p-8 flex flex-col"
                  >
                  ...
                  <motion.div
                    ...
                    className="md:col-span-2 bg-[#1A1817] border border-[var(--soouls-accent)]/10 rounded-[24px] p-10 relative overflow-hidden group"
                  >
                ...
                <div className="lg:col-span-1 flex flex-col gap-8">
                  ...
                  <motion.div
                    ...
                    className="bg-[#111111] border border-white/[0.05] rounded-[24px] p-8 flex flex-col gap-8 flex-1"
                  >
                    <div className="flex items-center justify-between">
                  ...
                  <motion.div
                    ...
                    className="bg-[#111111] border border-white/[0.05] rounded-[24px] p-8 flex flex-col gap-8"
                  >
                    <div className="flex items-center justify-between">
