      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, color-mix(in srgb, var(--soouls-accent) 20%, transparent), transparent)',
            }}
          />
        </motion.div>
        ...
        >
          <div
            ...
            style={{
              background:
                'linear-gradient(to bottom, color-mix(in srgb, var(--soouls-accent) 20%, transparent), transparent)',
            }}
          />
        </motion.div>
