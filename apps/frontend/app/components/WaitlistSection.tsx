...
export default function WaitlistSection() {
    ...
    return (
        ...
        >
            ...
            <div style={{ position: 'absolute', top: '10%', left: '5%', opacity: 0.1, pointerEvents: 'none' }}>
                <svg width="180" height="180" viewBox="0 0 180 180" fill="none">
                    <circle cx="60" cy="60" r="55" stroke="#FFFFFF" strokeWidth="1" />
                    <circle cx="120" cy="60" r="55" stroke="#FFFFFF" strokeWidth="1" />
                    <circle cx="90" cy="110" r="55" stroke="#FFFFFF" strokeWidth="1" />
                </svg>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                <div className="reveal inline-flex items-center mb-8">
                    ...
                    >
                        ...
                        <div className="relative" style={{ width: 8, height: 8 }}>
                            <div style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: '#D6C2A3', animation: 'ping-dot 1.5s ease-in-out infinite', position: 'absolute' }} />
                            <div style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: '#D6C2A3', position: 'relative' }} />
                        </div>
                        <span
                ...
                {/* Email form */}
                {!submitted ? (
                    <form onSubmit={handleSubmit} className="reveal flex flex-col sm:flex-row gap-4 justify-center max-w-xl mx-auto mb-10">
                        <div
                            style={{
                                flex: 1,
                        ...
                        >
                            <input
                                ...
                                style={{ fontSize: '16px', color: '#EFEBDD', letterSpacing: '-0.02em' }}
                            />
                        </div>
                        <button
                            type="submit"
                ...
                <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-4">
                    <span
                        className="font-urbanist"
                        style={{ fontSize: '13px', letterSpacing: '0.1em', color: '#A8A8A8' }}
                    >
                        LAUNCHING FALL 2026
                    </span>
                    ...
                    <span
                        className="font-urbanist"
                        style={{ fontSize: '13px', color: '#A8A8A8' }}
                    >
