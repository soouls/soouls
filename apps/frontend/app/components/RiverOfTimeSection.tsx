    ...
    return (
        <div
            ...
            style={{
                ...
                border: card.highlighted ? '1px solid rgba(224,122,95,0.4)' : '1px solid rgba(214,194,163,0.15)',
        ...
        >
            ...
            >
                <span
                    ...
                    style={{ fontSize: s.dateFontSize, color: '#EFEBDD', lineHeight: '1em', letterSpacing: '0.01em' }}
                >
                    {card.date}
                </span>
                <p
        ...
        >
            ...
            >
                ...
                <div className="reveal" style={{ marginBottom: '56px' }}>
                    ...
                    >
                        A seamless, non-linear architecture that lets your life flow naturally. Forget chronological constraints — connect moments by their emotional resonance
                    </p>
                </div>
                ...
                <div className="reveal">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span
                            ...
                            style={{ fontSize: '32px', lineHeight: '1em', color: '#E07A5F', letterSpacing: '-0.035em' }}
                        >
                            Dynamic Synthesis
                        </span>
                    </div>
                    <p
                        className="font-urbanist"
                        style={{ fontSize: '20px', lineHeight: '1.4em', color: '#EFEBDD', opacity: 0.8, maxWidth: '500px' }}
                    >
