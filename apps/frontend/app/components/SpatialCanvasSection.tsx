    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Soulcanvas gives you a spatial entry field where ideas, emotions, voice, notes, sketches, and tasks can coexist — naturally arranged the way your mind works
                </p>
            </div>
            ...
            <div
                ...
                style={{
                    maxWidth: '1317px',
                    height: '650px',
                    background: 'linear-gradient(156deg, rgba(214,194,163,1) 20%, rgba(214,194,163,1) 45%, rgba(207,188,158,1) 48%, rgba(207,188,158,1) 64%, rgba(207,188,158,1) 66%, rgba(207,188,158,1) 73%, rgba(112,102,85,1) 95%)',
                    borderRadius: '32px',
                    overflow: 'hidden',
                }}
            >
                ...
                <div
                    ...
                    style={{
                        left: '53px', top: '59px',
                        width: '336px', background: '#222', borderRadius: '16px',
                        padding: '34px 28px',
                    }}
                >
                ...
                <div
                    ...
                    style={{
                        left: '463px', top: '123px',
                        width: '301px', height: '229px',
                        background: '#222',
                        borderRadius: '16px',
                        overflow: 'hidden',
                        display: 'flex',
                ...
                >
                    ...
                    />
                    <span className="font-urbanist relative z-10" style={{ fontSize: '20px', color: '#D8D8D8', textAlign: 'center' }}>
                        Deserted evening
                    </span>
                </div>
                ...
                <div
                    ...
                    style={{
                        left: '59px', top: '361px',
                        width: '383px', background: '#1C1C1C',
                        borderRadius: '13px', padding: '16px',
                    }}
                >
                    {/* Waveform visualization */}
                    <div className="flex items-center gap-1 mb-2" style={{ height: '56px' }}>
                        <div style={{ width: 32, height: 32, borderRadius: '8px', background: '#222', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                >
                    {[
                        ...
                        <div key={i} className="flex items-center gap-3 mb-3">
                            <div style={{ width: 20, height: 20, border: '1px solid #A8A8A8', borderRadius: 5 }} />
                            <span className="font-urbanist" style={{ fontSize: '15px', color: '#D8D8D8' }}>{t.label}</span>
                        </div>
                    ))}
                </div>
                ...
                <div
                    ...
                    style={{
                        left: '799px', top: '59px',
                        width: '295px', background: 'rgba(15,15,15,0.5)',
                ...
                >
                    <p className="font-urbanist mb-3" style={{ fontSize: '18px', color: '#D8D8D8', lineHeight: 1.4 }}>
                        I will complete the design system task today
                    </p>
                    <div className="flex items-center gap-2">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="#A8A8A8" strokeWidth="1.5" /><path d="M8 5V8.5L10 10" stroke="#A8A8A8" strokeWidth="1.5" strokeLinecap="round" /></svg>
                ...
                <div
                    ...
                    style={{
                        ...
                        opacity: 0.59, whiteSpace: 'nowrap',
                    }}
                >
