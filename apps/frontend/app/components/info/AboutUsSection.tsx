...
import { GitMergeIcon, Heart, Linkedin, LockIcon, MoonIcon } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-[1000px] mx-auto">
        ...
        <div className="mb-16 md:mb-24 text-center max-w-[800px] mx-auto reveal">
          ...
          <h1 className="font-playfair text-4xl sm:text-5xl md:text-6xl font-bold text-[var(--ink)] leading-tight mb-8">
            Built by people who couldn't <em className="italic text-[#E07A5F]">find this</em>{' '}
            anywhere else
          </h1>
          <p className="font-urbanist text-lg text-[var(--ink-soft)] max-w-xl mx-auto">
            Soouls started as the tool two overwhelmed minds needed for themselves, before it was
            ever meant to be a company.
          </p>
        </div>
        ...
        <div className="relative bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 rounded-3xl md:rounded-[3rem] p-6 sm:p-8 md:p-16 mb-20 md:mb-32 max-w-[800px] mx-auto reveal overflow-hidden group shadow-[0_10px_30px_rgba(224,122,95,0.05)] hover:shadow-[0_20px_40px_rgba(224,122,95,0.08)] transition-colors transition-transform transition-shadow duration-300">
          ...
          <div className="relative z-10 prose prose-lg md:prose-xl font-urbanist text-[var(--ink-soft)] prose-p:leading-relaxed mx-auto">
            <p>
              We kept losing ourselves in productivity apps built for output — streaks, dashboards,
              guilt. Our thoughts deserved better than a to-do list with a diary bolted on.
            </p>
            <p>
            ...
            {[
              {
                ...
                desc: 'End-to-end encrypted, never sold, never used to train anything. Not a policy that can quietly change later — an architecture decision.',
              },
              {
                icon: MoonIcon,
                title: 'Quiet, not addictive',
                desc: "No streak-shaming, no infinite scroll, no push notification designed to make you anxious. If you leave for a month, we're just glad you're back.",
              },
              {
                icon: GitMergeIcon,
                title: 'Non-linear on purpose',
                desc: "Your mind doesn't file itself into folders and dates. We built the product around how thinking actually happens, not how filing cabinets work.",
              },
            ].map((val, idx) => {
              const Icon = val.icon;
              return (
                <div
                  key={idx}
                  className="group relative bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 rounded-3xl md:rounded-[2.5rem] p-10 transition-colors transition-transform transition-shadow duration-300 hover:bg-white/90 hover:shadow-[0_20px_40px_rgba(224,122,95,0.08)] hover:-translate-y-2 reveal overflow-hidden"
                ...
                >
                  ...
                  <h4 className="relative z-10 font-playfair text-2xl font-bold text-[var(--ink)] mb-4">
                    {val.title}
                  </h4>
        ...
        <div className="mb-20 md:mb-32 max-w-[800px] mx-auto">
          ...
          <div className="relative space-y-8 md:space-y-0 before:absolute before:inset-0 before:ml-[23px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-px before:bg-gradient-to-b before:from-transparent before:via-[#e3dbcd] before:to-transparent">
            {[
              {
                time: 'Early days',
                title: "A notes app that wouldn't stay organized",
                desc: 'The first version was a personal tool — scattered notes that refused to fit into folders, which turned out to be the point.',
              },
              {
                time: 'First map',
                title: 'The Spatial Canvas idea',
                desc: 'Instead of forcing entries into a list, we let them sit in space — and the shape of the canvas became the insight itself.',
              },
              {
                time: 'Early access',
                title: 'Sunday Review & first users',
                desc: "A handful of overthinkers, night writers, and one very patient therapist started using it weekly. Most of the product's honesty came from listening to them.",
              },
              {
                time: 'Today',
                title: '10,000+ people mapping their minds',
                desc: 'Grown without ad spend, one quiet recommendation at a time.',
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="relative flex items-start md:justify-between md:odd:flex-row-reverse group reveal"
              ...
              >
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-8 rounded-2xl md:rounded-[2rem] bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 ml-4 md:ml-0 md:group-odd:text-right hover:bg-white hover:shadow-lg transition-all active:scale-[0.98] duration-200">
                  <span className="font-urbanist text-[11px] font-bold text-[#E07A5F] font-semibold tracking-tight mb-3 block">
                    {item.time}
                  </span>
                  <h5 className="font-playfair text-2xl font-bold text-[var(--ink)] mb-3">
                    {item.title}
                  </h5>
            ...
            {[
              {
                ...
                img: '/Rudra.jpg',
                linkedin: 'https://www.linkedin.com/in/rudra-singh-73554623b/',
              },
              {
                name: 'Bhargav',
                role: 'Co-founder and CDO',
                img: '/Bhargav.jpeg',
              ...
              },
              {
                ...
                img: '/shreya.jpeg',
                linkedin: 'https://www.linkedin.com/in/shreya-garg-281aa7219/',
              },
              {
                name: 'Sreyashree',
                role: 'UI/UX Product Designer',
                img: '/Sreya%20Shree.jpeg',
                linkedin: 'https://www.linkedin.com/in/dsreyashree2006/',
              },
              { name: 'Subhranil', role: 'Fullstack Dev', img: '/Subhranil.jpeg' },
              {
                name: 'Varun',
                role: 'App and Frontend Dev',
                img: '/varun.jpeg',
                linkedin: 'https://www.linkedin.com/in/varun-patel-16611631a/',
              },
            ].map((member, idx) => (
              <div
                key={idx}
                className="text-center group reveal flex flex-col items-center"
                style={{ transitionDelay: `${idx * 100}ms` }}
              >
                ...
                <h5 className="font-playfair text-xl font-bold text-[var(--ink)] mb-1 flex items-center justify-center gap-2">
                  ...
                  {member.linkedin && (
                    <a
                      ...
                      className="text-[#E07A5F] hover:text-[#c96a51] transition-colors"
                      title={`LinkedIn of ${member.name}`}
                    >
