  ...
  const sections = [
    {
      ...
      content: (
        <p>
          These Terms of Service govern your use of Soouls, including the web application, iOS app,
          and Android app (together, the "Service"). By creating an account or using the Service,
          you agree to be bound by these terms. If you don't agree, please don't use Soouls.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          You must be at least 16 years old to create a Soouls account. You're responsible for
    ...
    },
    {
      ...
      content: (
        <>
          <p className="mb-4">
            Node is free indefinitely. Soul and Universe are paid subscriptions billed monthly or
            annually. Subscriptions renew automatically until cancelled. You can cancel at any time
            from Settings; cancellation takes effect at the end of the current billing period, and
            we do not provide partial-period refunds except where required by law (such as our
            14-day money-back window).
          </p>
          <p>
            Prices may change with at least 30 days' notice. Downgrading a plan never deletes your
            existing entries — you simply lose access to higher-tier features.
          </p>
        </>
      ),
    },
        ...
        <>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex gap-2">
              <span className="text-[#E07A5F]">•</span> Violate any applicable law or the rights of
              others.
            </li>
            <li className="flex gap-2">
              <span className="text-[#E07A5F]">•</span> Attempt to gain unauthorized access to other
              accounts.
            </li>
            <li className="flex gap-2">
              <span className="text-[#E07A5F]">•</span> Reverse-engineer, scrape, or interfere with
              infrastructure.
            </li>
            <li className="flex gap-2">
              <span className="text-[#E07A5F]">•</span> Upload malicious code or disrupt the
              Service.
            </li>
          </ul>
        </>
    ...
    },
    {
      ...
      content: (
        <p>
          You retain full ownership of everything you write, record, or draw in Soouls. By using the
          Service, you grant us a limited license to store, encrypt, transmit, and process your
          content <em>solely</em> to provide the features you use (like generating your Sunday
          Review).
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          ...
          error-free. We may update, modify, or discontinue features over time; where a change
          materially reduces functionality on a paid plan, we'll provide reasonable notice.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          ...
          accounts that violate these terms, with notice where practical. Upon termination, your
          right to use the Service ends, though your data deletion rights remain unaffected.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          Soouls is a personal reflection tool. It is not a substitute for professional medical,
          psychological, or psychiatric advice, diagnosis, or treatment. If you're experiencing a
          mental health crisis, please contact a licensed professional or local emergency services.
    ...
    },
    {
      ...
      content: (
        <p>
          To the maximum extent permitted by law, Soouls and its team will not be liable for any
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          <a href="mailto:legal@soouls.in" className="text-[#E07A5F] hover:underline font-bold">
            legal@soouls.in
          </a>
          .
        </p>
