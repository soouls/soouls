              ...
              <form className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-3">
                    <label htmlFor="contactName" className="font-urbanist text-[11px] font-bold text-[var(--ink-soft)] font-semibold tracking-tight ml-4">
                      Name
                    </label>
                    <input
                      id="contactName"
                  ...
                  <div className="flex flex-col gap-3">
                    <label htmlFor="contactEmail" className="font-urbanist text-[11px] font-bold text-[var(--ink-soft)] font-semibold tracking-tight ml-4">
                      Email
                    </label>
                    <input
                      id="contactEmail"
                ...
                <div className="flex flex-col gap-3">
                  <label htmlFor="contactMessage" className="font-urbanist text-[11px] font-bold text-[var(--ink-soft)] font-semibold tracking-tight ml-4">
                    Message
                  </label>
                  <textarea
                    id="contactMessage"
