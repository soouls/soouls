      ...
      <div className="relative z-10 max-w-[1240px] mx-auto">
        <div className="mb-16 md:mb-24 max-w-[800px] reveal">
          ...
          <p className="font-urbanist text-xl text-[var(--ink-soft)] mb-12 max-w-xl leading-relaxed">
            Whether you have a question, a suggestion, or just want to share your thoughts — we are
            always listening.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-start mb-20 md:mb-32">
          ...
          {/* Right: Contact Form */}
          <div
            className="lg:col-span-7 p-6 sm:p-8 md:p-14 rounded-3xl md:rounded-[3rem] bg-[#fdfaf6]/80 backdrop-blur-3xl border border-[#e3dbcd]/60 relative overflow-hidden shadow-[0_10px_40px_rgba(22,19,15,0.03)] reveal group"
              ...
              <form className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-3">
                    <label
                      htmlFor="contactName"
                      className="font-urbanist text-[11px] font-bold text-[var(--ink-soft)] font-semibold tracking-tight ml-4"
                    >
                      Name
                    </label>
                    <input
