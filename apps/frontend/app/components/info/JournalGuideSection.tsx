          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div 
                key={step.id} 
                id={step.id}
                className="group relative bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 rounded-2xl md:rounded-[2rem] p-6 md:p-10 transition-all duration-500 hover:bg-white/90 hover:shadow-[0_20px_40px_rgba(224,122,95,0.08)] hover:-translate-y-1 reveal z-10"
                ...
                <div className="flex flex-col md:flex-row gap-8 relative z-10">
                  <div className="md:w-1/3 shrink-0">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-12 h-12 rounded-full bg-white border border-[#e3dbcd] flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-500 shrink-0">
