...
import { BookOpen, Compass, Focus, Map as MapIcon, Sparkles } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      content: (
        <>
          <p className="mb-4">
            When you first open Soouls, you'll see a vast, empty space. This is intentional. Unlike
            a traditional journal where you write linearly down a page, Soouls allows you to place
            thoughts anywhere.
          </p>
          <p>
            Simply double-click anywhere on the canvas to create your first thought. It could be a
            word, a sentence, or a feeling. Once it's there, it becomes an anchor for everything
            else.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <p>
          As you add more thoughts, you'll naturally start to see relationships. You can draw lines
          between nodes to represent these connections. Over time, your isolated thoughts will form
          a rich, interconnected map of your mind, revealing how your ideas are truly linked.
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          The true magic of spatial journaling is the ability to zoom out. After a few weeks, take
          time to look at the clusters that have formed. You might discover recurring themes or
          unexpected links between ideas that you wouldn't have noticed in a linear, page-by-page
          journal.
        </p>
      ),
    },
      ...
      <div className="relative z-10 max-w-[900px] mx-auto">
        ...
        <div className="mb-16 md:mb-24 text-center reveal">
          ...
          <p className="font-urbanist text-lg text-[var(--ink-soft)] max-w-xl mx-auto">
            A gentle introduction to non-linear journaling and capturing your thoughts in a spatial
            canvas.
          </p>
        </div>
