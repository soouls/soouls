    ...
    <section className="relative w-full py-10 bg-transparent overflow-hidden">
      <div className="relative z-10 max-w-[900px] mx-auto">
        ...
        <div className="mb-16 md:mb-24 text-center reveal">
          ...
          <span className="font-urbanist text-[11px] font-bold text-[var(--soouls-accent)] tracking-[0.3em] uppercase mb-4 block">
            Legal & Trust
          </span>
          ...
          {sections.map((sec, idx) => {
            ...
            return (
              <div 
                key={sec.id} 
                id={sec.id}
                className="group relative bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 rounded-2xl md:rounded-[2rem] p-6 md:p-10 transition-all duration-500 hover:bg-white/90 hover:shadow-[0_20px_40px_rgba(217,138,75,0.08)] hover:-translate-y-1 reveal"
                style={{ transitionDelay: `${(idx % 5) * 100}ms` }}
              >
                {/* Decorative Glow */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[var(--soouls-accent)]/5 to-transparent rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                  ...
                  <div className="md:w-1/3 shrink-0">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-10 h-10 rounded-full bg-white border border-[#e3dbcd] flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-500">
                        <Icon className="w-5 h-5 text-[var(--ink)] group-hover:text-[var(--soouls-accent)] transition-colors duration-500" />
                      </div>
