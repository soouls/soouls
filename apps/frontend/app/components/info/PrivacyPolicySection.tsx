      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-6">
        ...
        <div className="max-w-3xl mb-24">
          ...
          <p className="font-urbanist text-2xl text-[#EFEBDD] leading-relaxed font-light italic opacity-90">
            "Your thoughts are sacred. In this digital sanctuary, we treat your reflections with the
            same reverence you bring to the page."
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-32">
          <div className="p-10 rounded-[48px] bg-white/[0.02] border border-white/[0.05] h-full">
            <h3 className="font-urbanist text-[11px] font-bold text-[#888888] tracking-[0.3em] uppercase mb-8">
              What we collect
            </h3>
          ...
          <div className="p-10 rounded-[48px] bg-[#1D2122] border border-[#E07A5F]/10 h-full relative overflow-hidden">
            ...
            <h4 className="font-urbanist text-[11px] font-bold text-[#E07A5F] tracking-[0.3em] uppercase mb-8">
              The Second Boundary
            </h4>
        ...
        <div className="relative group mb-32 p-16 rounded-[64px] bg-black/40 border border-white/[0.03] flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <h3 className="font-urbanist text-3xl font-bold text-[#EFEBDD] mb-4">
              Uncompromising Security
            </h3>
            <p className="font-urbanist text-[#A8A8A8] text-lg leading-relaxed max-w-xl">
              Every meditation and entry is encrypted before it leaves your device. We use
              industry-standard AES-256 encryption, ensuring that even in the unlikely event of a
              breach, your thoughts remain unreadable ciphers to everyone but you.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
          <div>
            ...
            <p className="font-urbanist text-lg text-[#A8A8A8] leading-relaxed">
              You are in control. You can export your data anytime. You can delete your account and
              its associated encryption keys, rendering all data on our servers useless and purged.
            </p>
          </div>
