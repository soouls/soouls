      ...
      <div className="relative z-10 max-w-[1240px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mb-20 md:mb-32">
          {socials.map((item, idx) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative p-12 rounded-3xl md:rounded-[3rem] bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 hover:bg-white hover:shadow-[0_20px_40px_rgba(224,122,95,0.08)] hover:-translate-y-2 transition-all duration-700 flex flex-col items-center text-center overflow-hidden reveal"
            ...
            >
              ...
              <div className="relative z-10">
                <div
                  className="w-20 h-20 mx-auto rounded-3xl bg-white border border-[#e3dbcd] shadow-sm flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500"
        ...
        <div className="max-w-[1000px] mx-auto reveal" style={{ transitionDelay: '300ms' }}>
          <div className="relative p-8 sm:p-12 md:p-24 rounded-3xl md:rounded-[2.5rem] md:rounded-[4rem] bg-gradient-to-br from-[#fdfaf6]/80 to-[#fdfaf6]/40 backdrop-blur-3xl border border-[#e3dbcd]/60 flex flex-col items-center text-center overflow-hidden shadow-[0_8px_32px_rgba(224,122,95,0.06)] group">
            ...
            <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-[#E07A5F]/10 blur-[80px] rounded-full -translate-y-1/2 -translate-x-1/2 pointer-events-none group-hover:opacity-100 opacity-50 transition-opacity duration-1000" />
            <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[var(--soouls-accent)]/10 blur-[80px] rounded-full translate-y-1/2 translate-x-1/2 pointer-events-none group-hover:opacity-100 opacity-50 transition-opacity duration-1000" />
            
            <div className="relative z-10 max-w-2xl">
              <span className="inline-flex p-4 rounded-3xl bg-white border border-[#e3dbcd] mb-10 text-[var(--soouls-accent)] shadow-sm group-hover:scale-110 transition-transform duration-500">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-10 py-5 bg-[var(--ink)] text-[#f7f3ec] font-urbanist font-bold tracking-widest text-sm uppercase rounded-full hover:scale-105 transition-transform duration-300 shadow-[0_10px_20px_rgba(22,19,15,0.15)]"
              >
