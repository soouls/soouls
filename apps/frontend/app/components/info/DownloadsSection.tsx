          ...
          {platforms.map((platform, idx) => {
            ...
            return (
              ...
              >
                {/* Glow Effects */}
                {!platform.isComingSoon && (
                  <div className="absolute top-0 right-0 w-40 h-40 bg-[var(--soouls-accent)]/10 blur-[50px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                )}
                ...
                <div className="flex flex-col relative z-10">
                  ...
                  <p className="font-urbanist text-[11px] font-bold text-[var(--ink-soft)] font-semibold tracking-tight mb-4">
                    {platform.subtitle}
                  </p>
                </div>
                ...
                {!platform.isComingSoon && platform.linkText ? (
                  <a
                    ...
                    className="group/link font-urbanist text-[var(--soouls-accent)] font-bold text-sm font-semibold tracking-tight flex items-center gap-2 transition-colors transition-transform transition-shadow relative z-10 mt-auto w-max"
                  >
                    {platform.linkText}
