...
import { ArrowRight, EyeOff, Feather, Layers, Sparkles, WifiOff } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto">
        ...
        <div className="mb-16 md:mb-24 text-center max-w-[800px] mx-auto reveal">
          ...
          <p className="font-urbanist text-lg text-[var(--ink-soft)] max-w-xl mx-auto">
            We stripped away everything that demands your attention, leaving only what helps you
            find it.
          </p>
        </div>
          ...
          {features.map((feat, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute -top-32 -right-32 w-64 h-64 rounded-full blur-[80px] opacity-0 group-hover:opacity-40 transition-opacity duration-500 pointer-events-none ${idx % 2 === 0 ? 'bg-[var(--soouls-accent)]' : 'bg-[#6450d6]'}`}
                />
                <div
                  className={`absolute -bottom-32 -left-32 w-64 h-64 rounded-full blur-[80px] opacity-0 group-hover:opacity-30 transition-opacity duration-500 pointer-events-none ${idx % 2 === 0 ? 'bg-[#E07A5F]' : 'bg-[var(--soouls-accent)]'}`}
                />
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-3xl bg-white border border-[#e3dbcd] shadow-sm flex items-center justify-center mb-10 group-active:scale-95 group-hover:rotate-3 transition-transform duration-300">
                    <Icon
                      size={28}
                      strokeWidth={1.5}
                      className="text-[var(--ink)] group-hover:text-[var(--soouls-accent)] transition-colors duration-300"
                    />
                  </div>
          ...
          <div className="relative bg-gradient-to-br from-[var(--ink)] to-[#2a251e] border border-[#e3dbcd]/20 shadow-[0_20px_60px_rgba(22,19,15,0.3)] rounded-[2rem] md:rounded-[4rem] p-8 sm:p-12 md:p-24 overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="font-urbanist text-lg text-[#928a7c] max-w-xl mx-auto mb-12">
                ...
                without an internet connection. Real-time sync works quietly in the background.
              </p>

              <Link
                href="/sign-up"
                className="group/btn relative px-10 py-5 inline-block bg-[var(--soouls-accent)] text-white rounded-full font-urbanist font-bold text-sm font-semibold tracking-tight overflow-hidden shadow-[0_10px_30px_rgba(217,138,75,0.3)] active:scale-[0.97] transition-all duration-200"
              >
