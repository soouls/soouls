    ...
    <section id="security" className="relative w-full py-10 bg-transparent overflow-hidden">
      <div className="relative z-10 max-w-[1240px] mx-auto">
        ...
        <div className="max-w-[800px] mb-16 md:mb-24 mx-auto text-center reveal">
          ...
          <p className="font-urbanist text-[11px] font-bold text-[var(--soouls-accent)] tracking-[0.4em] uppercase mb-6 block">
            Security & Architecture
          </p>
          <h1 className="font-playfair text-4xl sm:text-5xl md:text-7xl font-bold text-[var(--ink)] leading-tight mb-8">
            Your thoughts are <br className="hidden md:block"/> <em className="italic text-[var(--soouls-accent)]">strictly yours</em>
          </h1>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-[rgba(var(--soouls-bg-elevated-rgb),1)] border border-[var(--soouls-border)] shadow-sm flex items-center justify-center text-[var(--soouls-accent)] mb-8 group-active:scale-95 group-hover:-rotate-3 transition-transform duration-300">
        ...
        <div className="max-w-[1000px] mx-auto reveal" style={{ transitionDelay: '300ms' }}>
          <div className="relative p-8 sm:p-12 md:p-24 rounded-[2rem] md:rounded-[4rem] bg-gradient-to-br from-[rgba(var(--soouls-bg-elevated-rgb),0.8)] to-[rgba(var(--soouls-bg-elevated-rgb),0.4)] backdrop-blur-3xl border border-[var(--soouls-border)] flex flex-col items-center text-center overflow-hidden shadow-[0_8px_32px_rgba(var(--soouls-accent-rgb),0.06)] group">
            
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[rgba(var(--soouls-accent-rgb),0.1)] blur-[100px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none group-hover:opacity-100 opacity-50 transition-opacity duration-500" />
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <h3 className="font-playfair text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--ink)] mb-8">
                We don't <em className="italic text-[var(--soouls-accent)]">monetize</em> your mind
              </h3>
              ...
              <div className="pt-12 border-t border-[var(--soouls-border)] w-full flex flex-col items-center">
                ...
                <a
                  ...
                  className="inline-flex px-10 py-5 bg-[var(--ink)] text-[var(--paper)] font-urbanist font-bold tracking-widest text-sm uppercase rounded-full active:scale-[0.97] transition-all duration-200"
                >
                  safety@soouls.in
                </a>
              </div>
