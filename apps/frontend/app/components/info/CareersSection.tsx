  ...
  const vacancies = [
    {
      ...
      location: 'REMOTE',
      description:
        'Crafting the calmest digital experiences ever made. Help us invent the future of the Spatial Canvas.',
    },
    {
      title: 'Core Engineer',
      type: 'FULL-TIME',
      location: 'REMOTE',
      description:
        'Building the highly performant, local-first engine behind our canvas using modern sync technologies.',
    },
    {
      ...
      location: 'REMOTE',
      description:
        'Nurture our sanctuary of thinkers. Foster deep conversations and gather profound product insights.',
    },
  ];
    ...
    <section id="careers" className="relative w-full py-10 bg-transparent overflow-hidden">
      <div className="relative z-10 max-w-[1240px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-24 gap-12 reveal">
          ...
          <div className="flex flex-col items-start md:items-end text-left md:text-right max-w-sm">
            <div className="p-6 rounded-3xl bg-[#fdfaf6]/60 backdrop-blur-md border border-[#e3dbcd]/50 shadow-sm relative">
              <div className="absolute -left-3 top-6 text-4xl text-[#E07A5F]/30 font-playfair italic">
                "
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 mb-20 md:mb-32">
          {/* Values Column */}
          <div
            className="lg:col-span-5 flex flex-col gap-10 reveal"
          ...
          >
            ...
            {[
              ...
              <div
                key={idx}
                className="group relative pl-8 border-l-2 border-[#e3dbcd] hover:border-[#E07A5F] transition-colors duration-300"
              >
          ...
          <div className="relative p-8 sm:p-12 md:p-24 rounded-3xl md:rounded-[2.5rem] md:rounded-[4rem] bg-gradient-to-br from-[var(--ink)] to-[#2a251e] border border-[#e3dbcd]/20 shadow-[0_20px_60px_rgba(22,19,15,0.3)] flex flex-col items-center text-center overflow-hidden group">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="font-urbanist text-[#928a7c] text-lg mb-12 mx-auto leading-relaxed">
                Don't see a role that fits? We are always looking for passionate thinkers,
                designers, and builders. Tell us why you belong here.
              </p>
              <button
                type="button"
