      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-32">
          ...
          <div className="grid grid-cols-1 gap-12">
            {[
              ...
              <div key={value.label} className="border-l-2 border-[#E07A5F]/30 pl-8">
                <h4 className="font-urbanist font-bold text-[#EFEBDD] text-lg mb-2 uppercase tracking-widest">
                  {value.label}
                </h4>
                <p className="font-urbanist text-[#A8A8A8] text-base leading-relaxed">
                  {value.text}
                </p>
              </div>
            ))}
          ...
          <div className="space-y-6">
            <h3 className="font-urbanist text-xs font-bold text-[#888888] tracking-[0.3em] uppercase mb-8">
              Current Vacancies
            </h3>
            {vacancies.map((job) => (
              <div
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <h4 className="font-urbanist text-2xl font-semibold text-[#EFEBDD]">
                    {job.title}
                  </h4>
        ...
        <div className="relative p-16 rounded-[64px] bg-[#1D2122] border border-white/[0.05] flex flex-col items-center text-center overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="font-playfair text-5xl font-bold text-[#D6C2A3] italic mb-6">
              Join the sanctuary
            </h3>
