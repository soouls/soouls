  ...
  return (
    <footer className="relative z-10 w-full overflow-hidden bg-gradient-to-b from-transparent to-[#fdfaf6]/80 pt-20 md:pt-32 pb-8 border-t border-[var(--line)]">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-24 pb-16 border-b border-[var(--line)] reveal">
          <div>
            ...
            <p className="font-urbanist text-lg text-[var(--ink-soft)] max-w-md">
              A private space for your quietest thoughts. Join thousands of souls exploring their
              minds.
            </p>
          </div>
          <Link
            href="/sign-up"
            className="group relative px-7 py-3 w-full md:w-auto bg-[var(--ink)] text-[#f7f3ec] rounded-full font-urbanist font-semibold text-[15px] tracking-tight transition-all active:scale-[0.97] duration-200"
          >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-24 mb-32">
          ...
          <div className="max-w-sm flex flex-col gap-8 reveal" style={{ transitionDelay: '100ms' }}>
            <Link href="/" className="group flex items-center gap-3 w-fit">
              ...
              <span className="font-playfair text-3xl text-[var(--ink)] italic group-hover:opacity-80 transition-opacity">
                Soouls
              </span>
            </Link>
            <p className="font-urbanist text-[var(--ink-soft)] text-base leading-relaxed">
              We build tools for introspection, not extraction. Your data is yours, your mind is
              yours. Welcome to the quietest place on the internet.
            </p>
            ...
            <div className="flex gap-4 items-center pt-2">
              {[
                ...
                {
                  icon: Instagram,
                  href: 'https://www.instagram.com/soouls.in/?hl=en',
                  label: 'Instagram',
                },
                {
                  icon: Linkedin,
                  href: 'https://www.linkedin.com/company/soouls/?viewAsMember=true',
                  label: 'LinkedIn',
                },
          ...
          <div className="flex gap-12 md:gap-20 flex-wrap lg:flex-nowrap w-full lg:w-auto justify-between lg:justify-end">
            {/* Column 1 */}
            <div
              className="flex flex-col gap-6 min-w-[140px] reveal"
            ...
            >
              ...
              {[
                ...
                <Link
                  key={link.name}
                  href={link.href}
                  className="group flex items-center font-urbanist text-[15px] text-[var(--ink-soft)] hover:text-[#d98a4b] hover:opacity-80 transition-all duration-200"
                >
                  {link.name}
                </Link>
              ))}
        ...
        {/* Footer Bottom Meta */}
        <div
          className="border-t border-[var(--line)] pt-8 pb-4 flex flex-col md:flex-row justify-between items-center text-xs text-[var(--ink-faint)] font-urbanist gap-6 reveal"
        ...
        >
          ...
          <span className="tracking-wide">
            © {new Date().getFullYear()} Soouls, Inc. All thoughts remain yours.
          </span>
          <div className="flex gap-4">
            <span className="hover:text-[var(--ink-soft)] transition-colors cursor-default">
              Crafted with care
            </span>
            <span className="hover:text-[var(--ink-soft)] transition-colors cursor-default">
              For quieter minds
