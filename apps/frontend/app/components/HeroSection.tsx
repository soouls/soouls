...
export default function HeroSection() {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        ...
        .fromTo(
          '.hero-deco',
          { scale: 0, opacity: 0 },
          { scale: 1, opacity: 0.6, duration: 0.5, stagger: 0.1, ease: 'back.out(3)' },
          '-=0.6',
        )
        .fromTo(
          '.scroll-hint',
  ...
  return (
    <section
      ref={containerRef}
      className="relative pt-28 md:pt-40 pb-20 px-6 w-full text-center z-10 min-h-screen flex flex-col justify-center items-center overflow-hidden"
    >
      ...
      <div className="hero-deco" style={{ top: '12%', left: '18%' }}>
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          <circle cx="14" cy="14" r="5" fill="#d98a4b" opacity="0.35" />
          <circle cx="14" cy="14" r="13" stroke="#d98a4b" strokeWidth="1" opacity="0.15" />
        </svg>
      </div>
      ...
      <div className="hero-deco" style={{ bottom: '18%', right: '22%' }}>
        <svg width="16" height="16" viewBox="0 0 16 16">
          <circle cx="8" cy="8" r="3" fill="#7d9b76" opacity="0.2" />
        </svg>
      </div>
      <div className="hero-deco" style={{ top: '20%', left: '35%' }}>
        <svg width="6" height="6" viewBox="0 0 6 6">
          <circle cx="3" cy="3" r="3" fill="#d98a4b" opacity="0.4" />
        </svg>
      </div>
      <div className="hero-deco" style={{ top: '65%', left: '28%' }}>
        <svg width="8" height="8" viewBox="0 0 8 8">
          <circle cx="4" cy="4" r="4" fill="#cf7b6e" opacity="0.25" />
        </svg>
      </div>
      <div className="hero-deco" style={{ bottom: '40%', right: '30%' }}>
        <svg width="10" height="10" viewBox="0 0 10 10">
          <rect x="1" y="1" width="8" height="8" rx="2" fill="#6d7fa3" opacity="0.15" />
        </svg>
      </div>
      ...
      <div className="chip-f cf1" aria-hidden="true">
        ...
        <div className="text-left">
          Voice note<small>3am thought · 0:42</small>
        </div>
        <span className="wave">
          <b />
          <b />
      ...
      <div className="chip-f cf2" aria-hidden="true">
        ...
        <div className="text-left">
          Inner weather<small>mostly light this week</small>
        </div>
      ...
      <div className="hero-inner max-w-4xl relative z-10 flex flex-col items-center">
        ...
        <h1 className="hero-title font-fraunces text-5xl sm:text-6xl md:text-[5.5rem] font-light tracking-tight mb-2 text-[var(--soouls-text-strong)] leading-[1.08]">
          <span className="hero-line-1 inline-block">Your thoughts,</span>
          <br />
          <span className="hero-line-2 inline-block">
            <em>finally on a map.</em>
          </span>
        </h1>
        ...
        >
          <path
            d="M6 14 C 60 4, 120 20, 172 10 S 232 6, 244 12"
            stroke="#d98a4b"
            strokeWidth="3"
            strokeLinecap="round"
          />
        ...
        <p className="hero-sub text-lg md:text-xl text-[var(--soouls-text-muted)] max-w-2xl mx-auto leading-relaxed mt-4 mb-10">
          Soouls is a private, non-linear journal where writing, voice notes, images, doodles and
          tasks connect into a living map of your mind — one quiet space to think, feel and reflect.
        </p>

        <div className="flex flex-col sm:flex-row gap-5 justify-center">
          <Link
            href="/sign-up"
            className="hero-cta-btn group relative px-8 py-3.5 rounded-full font-semibold text-[15px] tracking-tight bg-[#16130f] text-[#f7f3ec] transition-all active:scale-[0.97] duration-200"
          >
            <span className="relative z-10">Begin your map — it&apos;s free</span>
          </Link>
          <Link
            href="/dashboard"
            className="hero-cta-btn group px-8 py-3.5 rounded-full font-semibold text-[15px] tracking-tight border border-[var(--soouls-border)] hover:bg-[var(--soouls-border)]/50 transition-all active:scale-[0.97] duration-200 relative overflow-hidden"
          >
            <span className="relative z-10">Peek inside</span>
          </Link>
        </div>

        <p className="hero-trust mt-6 text-sm text-[var(--soouls-text-faint)] font-medium tracking-wide">
          No feeds. No followers. No noise. Just you.
        </p>
        ...
        <div className="hero-stats-bar">
          ...
          <div className="hero-stat">
            ...
            <span className="flex items-center gap-1">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="#d98a4b">
