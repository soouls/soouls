...
const testimonials = [
  {
    quote: "I stopped trying to journal in order. Now I just empty my head and let Soouls find the shape of it later.",
    author: "Priya, illustrator",
    bg: "#fdf6db",
    rot: "-2deg"
  },
  {
    quote: "The weekly reflection is the only productivity feature that's ever made me tear up a little, unexpectedly, on a Sunday.",
    author: "Tomás, product designer",
    bg: "#e6f0de",
    rot: "1deg"
  },
  {
    quote: "First app that made my 2am spirals feel like data I could look at, instead of doom I had to sit inside.",
    author: "Aiko, therapist",
    bg: "#ede3f8",
    rot: "-1.5deg"
  },
  {
    quote: "Six months of clusters later, I can actually see the shape of my grief getting smaller. I didn't expect that from an app.",
