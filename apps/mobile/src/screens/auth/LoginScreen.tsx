...
export function LoginScreen({ navigation }: any) {
  ...
  console.log('[LoginScreen] useSignIn result:', {
    isLoaded,
    hasSignIn: !!signIn,
  ...
  const onGooglePress = async () => {
    ...
    try {
      ...
      Alert.alert('Sign In Error', err.errors?.[0]?.message || 'Failed to sign in with Google.');
    } finally {
  ...
  const onApplePress = async () => {
    ...
    try {
      ...
      console.error('OAuth error', err);
      Alert.alert('Sign In Error', err.errors?.[0]?.message || 'Failed to sign in with Apple.');
    } finally {
    ...
    >
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Sign in to your Soouls account</Text>
        </View>
