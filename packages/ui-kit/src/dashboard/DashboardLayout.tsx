            ...
            <main className="lg:pl-64">
                ...
                <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-white/5 bg-[#0A0A0A]/80 px-8 backdrop-blur-xl">
                    ...
                    <div className="flex items-center gap-6">
                        <button type="button" className="text-slate-400 hover:text-base-cream transition-colors">
                            <Search className="h-5 w-5" />
                        </button>
                        <button type="button" className="text-slate-400 hover:text-base-cream transition-colors relative">
